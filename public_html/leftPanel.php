		...
		<ul class="nav" id="main-menu">
			<li>
				<div class="user-img-div">
					...
					<div class="inner-text">
						Username <br /> <small>Last Login : 2 Weeks Ago </small>
					</div>
				</div>

			</li>
			<li><a href="index.php" id="home"> <i class="fa fa-desktop "></i><?php echo $lang['LEFT_MENU_HOME']; ?>
				</a></li>
			...
			<li><a href="#"><i class="fa fa-yelp "></i><?php echo $lang['LEFT_MENU_LINGUA']; ?> <span
				...
				<ul class="nav nav-second-level">
					<li><a href="index.php?lang=it"><i class="fa fa-coffee"></i>Italiano</a>
					</li>
					<li><a href="index.php?lang=en"><i class="fa fa-flash "></i>English</a>
					</li>
